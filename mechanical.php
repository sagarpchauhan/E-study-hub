...
<html>
	...
	<br><br>
		...
		<tr height="40"><td align="center" bgcolor="lime" style="color:bisque; font-family: sans-serif;"><b>Mechanical Engg</b></td></tr>
	...
	<tr>
		<th colspan="4" align="center"><u><h2>Mechanical Engineering</h2></u></th>
	</tr>
	<tr>
		<th></th>
...
$query = "SELECT * FROM `bookinfo`,`userinfo` WHERE `bookinfo`.`uname`=`userinfo`.`uname` AND `bookinfo`.`branch`='mechanical'";
...
?>
	<tr>
		<td width="200"><img src="uploadimg/mechanical/<?php echo $data['addr']; ?>" width="200" height="200"></td>
