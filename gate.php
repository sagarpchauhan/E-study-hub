...
<html>
	...
	<br><br>
		...
		<tr height="40"><td align="center"><a href="mechanical.php">Mechanical Engg</a></td></tr>
             ...
             <tr height="40"><td align="center" bgcolor="lime" style="color:bisque; font-family: sans-serif;"><b>GATE Exam</b></td></tr>
            </table>
        </div>
        <div>
           <table border="2" width="70%" align="right">
	<tr>
		<th colspan="4" align="center"><u><h2>GATE Exam</h2></u></th>
	</tr>
<tr>
		<th></th>
...
$query = "SELECT * FROM `bookinfo`,`userinfo` WHERE `bookinfo`.`uname`=`userinfo`.`uname` AND `bookinfo`.`branch`='gate'";
...
?>
	<tr>
		<td width="200"><img src="uploadimg/gate/<?php echo $data['addr']; ?>" width="200" height="200"></td>
