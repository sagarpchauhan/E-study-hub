...
<html>
	...
	<br><br>
        <div id="menu1">
            <table bgcolor="#CCFFCC" border="1" align="left" width="25%" height="400">
                ...
                <tr height="40"><td align="center" bgcolor="lime" style="color:bisque; font-family: sans-serif;"><b>Computer Engg</b></td></tr>
	...
	<tr>
		<th colspan="4" align="center"><u><h2>Computer Engineering</h2></u></th>
	</tr>
<tr>
		<th></th>
...
$query = "SELECT * FROM `bookinfo`,`userinfo` WHERE `bookinfo`.`uname`=`userinfo`.`uname` AND `bookinfo`.`branch`='computer'";
...
?>
	<tr>
		<td width="200"><img src="uploadimg/computer/<?php echo $data['addr']; ?>" width="200" height="200"></td>
