	...
	<br><br>
        <div id="menu1">
            <table bgcolor="#CCFFCC" border="1" align="left" width="25%" height="400">
                ...
                <tr height="40"><td align="center"><a href="civil.php">Civil Engg</a></td></tr>
...
?>
		...
		<td><a href="mechanical.php"><img src="uploadimg/mechanical/<?php echo $data['addr']; ?>" height="100" width="100"  onmouseover="click1(this)" onmouseout="click2(this)" ></a></td>
<?php
	$i++;
	}
	}
...
?>
		...
		<td><a href="computer.php"><img src="uploadimg/computer/<?php echo $data['addr']; ?>" height="100" width="100"  onmouseover="click1(this)" onmouseout="click2(this)"></a></td>
<?php
	$i++;
	}
	}
...
?>
		...
		<td><a href="electrical.php"><img src="uploadimg/electrical/<?php echo $data['addr']; ?>" height="100" width="100"  onmouseover="click1(this)" onmouseout="click2(this)" ></a></td>
<?php
	$i++;
	}
	}
...
?>
		...
		<td><a href="civil.php"><img src="uploadimg/civil/<?php echo $data['addr']; ?>" height="100" width="100"  onmouseover="click1(this)" onmouseout="click2(this)" ></a></td>
<?php
	$i++;
	}
	}
...
?>
		...
		<td><a href="gate.php"><img src="uploadimg/gate/<?php echo $data['addr']; ?>" height="100" width="100"  onmouseover="click1(this)" onmouseout="click2(this)" ></a></td>
<?php
	$i++;
	}
	}
