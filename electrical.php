...
<html>
	...
	<tr height="40"><td align="center"><a href="mechanical.php">Mechanical Engg</a></td></tr>
                <tr height="40"><td align="center" bgcolor="lime" style="color:bisque; font-family: sans-serif;"><b>Electrical Engg</b></td></tr>                
	...
	<tr>
		<th colspan="5" align="center"><u><h2>Electrical Engineering</h2></u></th>
	</tr>
<tr>
		<th></th>
...
$query = "SELECT * FROM `bookinfo`,`userinfo` WHERE `bookinfo`.`uname`=`userinfo`.`uname` AND `bookinfo`.`branch`='electrical'";
...
?>
	<tr>
		<td width="200"><img src="uploadimg/electrical/<?php echo $data['addr']; ?>" width="200" height="200"></td>
